...
const Header = () => {
  ...
  return (
    ...
    viewPort={{once:true}}
    >
      <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral'
       initial={{opacity:0 , y:-20}}
       animate={{opacity:1,y:0}} 
       transition={{delay:0.2,duration:0.8}}
       >
      <p>
        Best text to image generate
      </p>
    ...
    <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'
     ...
     >Turn text to <span className='text-blue-500'>image</span>, in seconds.</motion.h1>
    <motion.p className='text-center max-w-xl mx-auto mt-5'
    initial={{opacity:0,y:20}}
    animate={{opacity:1,y:0}} 
    transition={{delay:0.6,duration:0.8}}
    >Unleash you creativity with AI. Turn your imagination into visual art in seconds - just type ,and watch  the magic happen. </motion.p>
